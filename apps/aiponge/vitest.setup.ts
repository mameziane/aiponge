...
vi.mock('react-native-track-player', () => ({
  ...
  State: { None: 'none', Playing: 'playing', Paused: 'paused', Stopped: 'stopped', Ready: 'ready', Buffering: 'buffering', Loading: 'loading', Error: 'error', Ended: 'ended', Connecting: 'connecting' },
  Event: { PlaybackState: 'playback-state', PlaybackError: 'playback-error', PlaybackActiveTrackChanged: 'playback-active-track-changed', PlaybackQueueEnded: 'playback-queue-ended', PlaybackProgressUpdated: 'playback-progress-updated', RemotePlay: 'remote-play', RemotePause: 'remote-pause', RemoteStop: 'remote-stop', RemoteNext: 'remote-next', RemotePrevious: 'remote-previous', RemoteSeek: 'remote-seek' },
  Capability: { Play: 'play', Pause: 'pause', Stop: 'stop', SeekTo: 'seek-to', SkipToNext: 'skip-to-next', SkipToPrevious: 'skip-to-previous' },
  RepeatMode: { Off: 0, Track: 1, Queue: 2 },
  AppKilledPlaybackBehavior: { ContinuePlayback: 'continue-playback', PausePlayback: 'pause-playback', StopPlaybackAndRemoveNotification: 'stop-playback-and-remove-notification' },
}));
