...
describe('Subscription Gating', () => {
  ...
  describe('Subscription Configuration', () => {
    it('should retrieve subscription tier configuration', async () => {
  ...
  describe('Explorer Tier Limitations', () => {
    it('should return quota information for free users', async () => {
      if (!freeUser) throw new Error('Test user not available');
    ...
    it('should restrict access to paid tier features', async () => {
      if (!freeUser) throw new Error('Test user not available');
    ...
    it('should return correct canGenerate flag based on quota usage', async () => {
      if (!freeUser) throw new Error('Test user not available');
  ...
  describe('Role-Based Access (Admin/Librarian)', () => {
    it('should deny librarian routes to regular users', async () => {
      if (!freeUser) throw new Error('Test user not available');
  ...
  describe('Usage Tracking', () => {
    it('should track generation usage correctly', async () => {
      if (!freeUser) throw new Error('Test user not available');
  ...
  describe('Feature Flags', () => {
    it('should return correct feature flags based on tier', async () => {
      if (!freeUser) throw new Error('Test user not available');
  ...
  describe('Upgrade Prompts', () => {
    it('should provide upgrade information when needed', async () => {
      if (!freeUser) throw new Error('Test user not available');
  ...
  describe('Quota Enforcement on Generation', () => {
    it('should verify quota enforcement for generation', async () => {
      if (!freeUser) throw new Error('Test user not available');
