...
describe('Credit Deduction Flow', () => {
  ...
  describe('Credit Balance Query', () => {
    it('should retrieve user credit balance', async () => {
    ...
    it('should include reserved and available credits', async () => {
      if (!testUser) throw new Error('Test user not available');
      ...
      console.log(`✅ Balance breakdown: total=${response.data.balance}, available=${response.data.available || 'N/A'}`);
    }, TEST_TIMEOUT);
  });

  describe('Credit Reservation', () => {
    it('should reserve credits for song generation', async () => {
      if (!testUser) throw new Error('Test user not available');
    ...
    it('should prevent double-spending with concurrent reservations', async () => {
      if (!testUser) throw new Error('Test user not available');
  ...
  describe('Credit Settlement', () => {
    it('should settle credits after successful operation', async () => {
      if (!testUser) throw new Error('Test user not available');
  ...
  describe('Credit Cancellation', () => {
    it('should cancel reservation and restore credits on failure', async () => {
      if (!testUser) throw new Error('Test user not available');
  ...
  describe('Credit Purchase Flow', () => {
    it('should list available credit packs', async () => {
      if (!testUser) throw new Error('Test user not available');
  ...
  describe('Credit Transaction History', () => {
    it('should retrieve credit transaction history', async () => {
      if (!testUser) throw new Error('Test user not available');
